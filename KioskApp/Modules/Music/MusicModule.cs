...
using KioskApp.Modules.Music.Common;
using KioskApp.Modules.Search.Services;

#endregion USING DIRECTIVES

namespace KioskApp.Modules.Music
{
    [Module(ModuleType.Music), NotBlocked]
    [Cooldown(3, 5, CooldownBucketType.Channel)]
    [RequireBotPermissions(Permissions.UseVoice)]
    public partial class MusicModule : KServiceModule<YtService>
    {
        // TODO: Move to SharedData or create transient module ?
